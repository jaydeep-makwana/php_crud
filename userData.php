...
<body class="user_welcome">
    ...
    <div class="table-responsive   ">
        <table class="table table-responsive userData bg-black text-center mt-5 user-table">
            <tr>
                <th colspan="2">
            ...
            <tr>
                <th>Id</th>
                <td> <?php echo $myData['id'];
                        ?> </td>
            </tr>
            <tr>
                <th>Fisrt_Name</th>
                <td><?php echo $myData['firstName'];
                    ?> </td>
            ...
            <tr>
                <th>Age</th>
                <td><?php echo $myData['age'];
                    ?> </td>

            </tr>
            <tr>
                <th>Gender</th>
                <td><?php echo $myData['gender'];
                    ?> </td>
            </tr>

            <tr>
                <th>Department</th>
                <td><?php echo $myData['department'];
                    ?> </td>
            </tr>

            <tr>
                <th>Date Of Join</th>
                <td><?php echo $myData['date_of_join'];
                    ?> </td>
            </tr>
            ...
            <tr>
                ...
                <td><?php echo $myData['salary'];
                    ?> </td>
            </tr>

            <tr>
                <th>Email</th>
                <td><?php echo $myData['email'];
                    ?> </td>
            </tr>

            <tr>
                <th>Password</th>
                <td><?php echo base64_decode($myData['password']);
                    ?> </td>
            </tr>

            <tr>
                <th>Hobbies</th>
                <td><?php echo $myData['hobby'];
                    ?> </td>
            </tr>

            <tr>
                <th>Photo</th>
                <td> <img src="<?php echo $myData['photo'];
                                ?>" alt="Network Error" hright='100px' width='100px'> </td>
            </tr>
